...
func newOrder(db *gorm.DB, opts ...gen.DOOption) order {
	...
	_order.GoodsID = field.NewInt64(tableName, "goods_id")
	_order.Num = field.NewInt32(tableName, "num")
	_order.RowState = field.NewInt32(tableName, "row_state")
...
type order struct {
	...
	Num      field.Int32 // 下单数量
	RowState field.Int32 // -1:下单回滚废弃 0:待支付
...
func (o *order) updateTableName(table string) *order {
	...
	o.RowState = field.NewInt32(table, "row_state")
...
func (o *order) fillFieldMap() {
	...
	o.fieldMap["row_state"] = o.RowState
}
